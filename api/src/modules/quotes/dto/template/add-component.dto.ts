import { IsString, IsOptional, IsObject, IsIn, ValidateNested } from 'class-validator';
...
export class AddComponentDto {
  @ApiPropertyOptional({ description: 'Component ID from library (optional)', example: 'global-header-modern' })
  @IsString()
  @IsOptional()
  component_id?: string;
  ...
  @ApiProperty({ description: 'Component position and sizing', type: ComponentPositionDto })
  @ValidateNested()
  @Type(() => ComponentPositionDto)
  position: ComponentPositionDto;

  @ApiPropertyOptional({ description: 'Component properties', example: { show_logo: true, company_name: 'My Company' } })
  @IsObject()
  @IsOptional()
  props?: Record<string, any>;

  @ApiPropertyOptional({ description: 'Custom styles', example: { backgroundColor: '#ffffff', padding: 20 } })
  @IsObject()
  @IsOptional()
  style?: Record<string, any>;

  @ApiPropertyOptional({ description: 'Data bindings (Handlebars)', example: { customer_name: '{{quote.lead.full_name}}' } })
  @IsObject()
  @IsOptional()
