...
class PartialComponentPositionDto {
  ...
  @ApiPropertyOptional({
    description: 'Width (pixels or "auto")',
    example: '50%',
  })
  width?: number | string;

  @ApiPropertyOptional({
    description: 'Height (pixels or "auto")',
    example: 100,
  })
...
class ComponentConditionsDto {
  @ApiPropertyOptional({
    description: 'Show component if condition is true',
    example: 'quote.discount_amount',
  })
  show_if?: string;

  @ApiPropertyOptional({
    description: 'Hide component if condition is true',
    example: 'quote.is_archived',
  })
  hide_if?: string;
}
...
export class UpdateComponentDto {
  @ApiPropertyOptional({
    description: 'Updated position/sizing',
  ...
  @ApiPropertyOptional({
    description: 'Updated component properties',
    example: { show_logo: false },
  })
  @IsObject()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Updated custom styles',
  ...
  @ApiPropertyOptional({
    description: 'Updated data bindings',
    example: { email: '{{quote.lead.email}}' },
  })
  @IsObject()
  @IsOptional()
