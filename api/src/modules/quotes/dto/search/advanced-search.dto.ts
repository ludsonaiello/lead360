...
export class AdvancedSearchDto {
  ...
  @ApiProperty({
    description: 'Quote number filter',
    example: 'Q-2024-001',
    required: false,
  })
  @IsOptional()
  ...
  @ApiProperty({
    ...
    example: 'created_at',
    enum: ['created_at', 'quote_number', 'total', 'title'],
    required: false,
    default: 'created_at',
  })
  @IsOptional()
...
export class SearchResultDto {
  ...
  @ApiProperty({ description: 'Total amount', example: 25000.0 })
  total: number;
...
export class AdvancedSearchResponseDto {
  ...
  @ApiProperty({
    ...
    example: { page: 1, limit: 20, total: 150, total_pages: 8 },
  })
  pagination: {
    page: number;
    limit: number;
