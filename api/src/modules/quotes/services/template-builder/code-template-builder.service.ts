...
export class CodeTemplateBuilderService {
  ...
  async updateTemplateCode(
    ...
    const css =
      dto.css_content !== undefined ? dto.css_content : existing.css_content;
  ...
  async getVariableSuggestions() {
    ...
    return {
      variables: [
        ...
        {
          path: 'quote.tax_amount',
          type: 'number',
          description: 'Tax amount',
          example: 500.0,
        },
        {
          path: 'quote.discount_amount',
          type: 'number',
        ...
        {
          path: 'quote.expires_at',
          type: 'date',
          description: 'Expiration date',
          example: '2026-03-01',
        },
        {
          path: 'quote.custom_terms',
          type: 'string',
        ...
        {
          path: 'quote.lead.full_name',
          type: 'string',
          description: 'Customer full name',
          example: 'John Smith',
        },
        {
          path: 'quote.lead.email',
          type: 'string',
          description: 'Customer email',
          example: 'john@example.com',
        },
        {
          path: 'quote.lead.phone',
          type: 'string',
          description: 'Customer phone',
          example: '(555) 123-4567',
        },
        {
          path: 'quote.lead.company_name',
          type: 'string',
        ...
        // Jobsite address
        {
          path: 'quote.jobsite_address.line1',
          type: 'string',
          description: 'Address line 1',
          example: '123 Main St',
        },
        {
          path: 'quote.jobsite_address.line2',
          type: 'string',
          description: 'Address line 2',
          example: 'Suite 200',
        },
        {
          path: 'quote.jobsite_address.city',
          type: 'string',
          description: 'City',
          example: 'Springfield',
        },
        {
          path: 'quote.jobsite_address.state',
          type: 'string',
          description: 'State',
          example: 'IL',
        },
        {
          path: 'quote.jobsite_address.zip_code',
          type: 'string',
        ...
        {
          path: 'quote.vendor.name',
          type: 'string',
          description: 'Vendor/Business name',
          example: 'ABC Contractors',
        },
        {
          path: 'quote.vendor.email',
          type: 'string',
          description: 'Vendor email',
          example: 'info@abccontractors.com',
        },
        {
          path: 'quote.vendor.phone',
          type: 'string',
          description: 'Vendor phone',
          example: '(555) 987-6543',
        },
        {
          path: 'quote.vendor.address_line1',
          type: 'string',
          description: 'Vendor address',
          example: '456 Business Blvd',
        },
        {
          path: 'quote.vendor.city',
          type: 'string',
          description: 'Vendor city',
          example: 'Springfield',
        },
        {
          path: 'quote.vendor.state',
          type: 'string',
          description: 'Vendor state',
          example: 'IL',
        },
        {
          path: 'quote.vendor.zip_code',
          type: 'string',
        ...
        {
          path: 'tenant.primary_contact_phone',
          type: 'string',
          description: 'Company phone',
          example: '(555) 111-2222',
        },
        {
          path: 'tenant.primary_contact_email',
          type: 'string',
          description: 'Company email',
          example: 'contact@mybusiness.com',
        },
        {
          path: 'tenant.website_url',
          type: 'string',
        ...
        {
          path: 'quote.items[].title',
          type: 'string',
          description: 'Item title',
          example: 'Cabinet Installation',
        },
        {
          path: 'quote.items[].description',
          type: 'string',
          description: 'Item description',
          example: 'Install 10 cabinets',
        },
        {
          path: 'quote.items[].quantity',
          type: 'number',
          description: 'Item quantity',
          example: 10,
        },
        {
          path: 'quote.items[].unit_measurement',
          type: 'string',
          description: 'Unit of measurement',
          example: 'each',
        },
        {
          path: 'quote.items[].total_cost',
          type: 'number',
        ...
        // Date fields
        {
          path: 'quote.created_at',
          type: 'date',
          description: 'Quote created date',
          example: '2026-02-01',
        },
        {
          path: 'quote.updated_at',
          type: 'date',
      ...
      helpers: [
        {
          ...
          description: 'Format as currency ($1,234.56)',
          example: '{{currency quote.total}}',
        },
        {
          name: 'date',
          syntax: '{{date value}}',
          description: 'Format as date (MM/DD/YYYY)',
          example: '{{date quote.expires_at}}',
        },
        {
          name: 'percent',
          syntax: '{{percent value}}',
          description: 'Format as percentage (12.5%)',
          example: '{{percent 0.125}}',
        },
        {
          name: 'eq',
          syntax: '{{#if (eq a b)}}',
          description: 'Check if two values are equal',
          example: '{{#if (eq quote.status "sent")}}',
        },
        {
          name: 'ne',
          syntax: '{{#if (ne a b)}}',
          description: 'Check if two values are not equal',
          example: '{{#if (ne quote.discount_amount 0)}}',
        },
        {
          name: 'gt',
          syntax: '{{#if (gt a b)}}',
          description: 'Check if a > b',
          example: '{{#if (gt quote.total 1000)}}',
        },
        {
          name: 'lt',
          syntax: '{{#if (lt a b)}}',
          description: 'Check if a < b',
          example: '{{#if (lt quote.items.length 10)}}',
        },
        {
          name: 'multiply',
          syntax: '{{multiply a b}}',
