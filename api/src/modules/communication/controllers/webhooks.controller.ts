...
/**
 * Email Provider Webhooks Controller
 *
 * PUBLIC endpoints for receiving webhook callbacks from email service providers.
 ...
 *
 * NOTE: Twilio webhooks (SMS, WhatsApp, Voice) have been moved to TwilioWebhooksController
 * at /api/v1/twilio/* for better organization.
 *
 * Security: All webhooks verify signatures before processing
 */
@ApiTags('Communication - Email Provider Webhooks')
