...
export class ProjectDashboardController {
  ...
  @ApiQuery({
    name: 'date_from',
    required: false,
    description: 'Filter projects created on or after (ISO 8601)',
  })
  @ApiQuery({
    name: 'date_to',
    required: false,
    description: 'Filter projects created on or before (ISO 8601)',
  })
  @ApiResponse({
    status: 200,
        ...
        recent_activity: {
          ...
          items: {
            ...
            properties: {
              ...
              description: {
                type: 'string',
                example: 'Completed task: Install countertops',
              },
              user_id: {
                type: 'string',
