...
/**
 * DTO for creating a cost entry from a task context.
 * project_id and task_id are taken from URL params — NOT from the body.
 */
export class CreateTaskCostEntryDto {
  @ApiProperty({
