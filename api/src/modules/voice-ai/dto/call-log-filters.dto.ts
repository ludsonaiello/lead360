...
export class CallLogFiltersDto {
  ...
  @ApiPropertyOptional({ description: 'End date (ISO 8601)', example: '2026-01-31T23:59:59Z' })
  @IsOptional()
  @IsDateString()
  to?: string;
...
export class AdminCallLogFiltersDto extends CallLogFiltersDto {
  @ApiPropertyOptional({ description: 'Filter by tenant ID (optional for cross-tenant queries)' })
  @IsOptional()
  @IsString()
  tenantId?: string;
}
...
export class AdminUsageReportFiltersDto {
  ...
  @ApiPropertyOptional({ description: 'Filter by provider type', enum: ['STT', 'LLM', 'TTS'] })
  @IsOptional()
  @IsString()
