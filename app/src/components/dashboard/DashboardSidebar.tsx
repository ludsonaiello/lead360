...
const navigation: (NavItem | NavGroup)[] = [
  ...
  { name: 'Calendar', href: '/calendar', icon: CalendarIcon, permission: 'calendar:view', roles: ['Owner', 'Admin', 'Estimator', 'Project Manager'] },
  ...
  { name: 'Crew Members', href: '/crew', icon: Wrench, permission: 'projects:view' },
  {
    ...
    items: [
      ...
      { name: 'My Hours', href: '/workforce/my-hours', icon: Timer, permission: 'timeclock:view_own' },
      { name: 'My Shifts', href: '/workforce/my-shifts', icon: CalendarCheck, permission: 'timeclock:view_own' },
      { name: 'Timesheets', href: '/workforce/timesheets', icon: FileText, permission: 'timeclock:view_all' },
      { name: 'Shifts', href: '/workforce/shifts', icon: CalendarIcon, permission: 'timeclock:manage_shifts' },
      { name: 'Assignments', href: '/workforce/assignments', icon: Link2, permission: 'timeclock:manage_employees' },
      { name: 'Disputes', href: '/workforce/disputes', icon: AlertTriangle, permission: 'timeclock:review_disputes' },
      { name: 'Reports', href: '/workforce/reports', icon: BarChart3, permission: 'timeclock:view_reports' },
      { name: 'Time Clock Settings', href: '/settings/time-clock', icon: Settings, permission: 'timeclock:manage_settings' },
    ],
  },
