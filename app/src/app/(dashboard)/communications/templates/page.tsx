 ...
 * Lists all email templates with filtering and search
 * Shows both admin templates and tenant templates
 */
...
import { Plus, Search, Filter, Eye, Edit, Trash2, FileText, X, Copy, Store } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <Link href="/communications/templates/gallery">
  ...
  return (
    <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 hover:shadow-md transition-shadow">
      ...
      <div className="flex items-center gap-2 pt-3 border-t border-gray-200 dark:border-gray-700">
        ...
        {template.template_type === 'tenant' ? (
          <>
            <Link
              href={`/communications/templates/${template.template_key}/edit`}
        ...
        ) : template.template_type === 'shared' && (
          <Link
            href={`/communications/templates/gallery?clone=${template.template_key}`}
...
// Template Preview Modal (placeholder - basic version)
function TemplatePreviewModal({ templateKey, onClose }: { templateKey: string; onClose: () => void }) {
  ...
  useEffect(() => {
    const fetchPreview = async () => {
      try {
        setLoading(true);
        // For preview, we need sample variables - using empty object for now
