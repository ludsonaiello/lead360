# Sprint 20: reminder_scheduling

**Sprint**: Backend Phase 4 - Sprint 20 of 42
**Module**: Calendar & Scheduling
**Estimated Duration**: 4-5 hours
**Prerequisites**: Sprint 19 complete

---

## 🎯 Sprint Goal

Integrate BullMQ scheduler for appointment reminders (24h + 1h)
...
Schedule 24h/1h reminders, skip logic, cancel on appointment changes
...
`/root/.claude/plans/curried-petting-bachman.md` - Sprint 20 section
...
**Implementation Plan**: `/root/.claude/plans/curried-petting-bachman.md` - Sprint 20
