# Sprint 31: external_blocks_non_available

**Sprint**: Backend Phase 1 (Frontend) - Sprint 31 of 42
**Module**: Calendar & Scheduling
**Estimated Duration**: 3-4 hours
**Prerequisites**: Sprint 30 complete

---

## 🎯 Sprint Goal

Display external blocks and non-available hours in calendar
...
Fetch and display external blocks, gray out non-available hours
...
`/root/.claude/plans/curried-petting-bachman.md` - Sprint 31 section
...
**Implementation Plan**: `/root/.claude/plans/curried-petting-bachman.md` - Sprint 31
