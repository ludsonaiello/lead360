# Sprint 37: appointment_type_settings

**Sprint**: Backend Phase 3 (Frontend) - Sprint 37 of 42
**Module**: Calendar & Scheduling
**Estimated Duration**: 3-4 hours
**Prerequisites**: Sprint 36 complete

---

## 🎯 Sprint Goal

Create appointment type settings page with duration and reminder toggles
...
Duration dropdown, max lookahead, reminder toggles
...
`/root/.claude/plans/curried-petting-bachman.md` - Sprint 37 section
...
**Implementation Plan**: `/root/.claude/plans/curried-petting-bachman.md` - Sprint 37
