# Sprint 12: outbound_sync

**Sprint**: Backend Phase 2 - Sprint 12 of 42
...
Implement appointment → Google Calendar event sync (create, update, delete)
...
Event mapping, BullMQ jobs, sync logging
...
`/root/.claude/plans/curried-petting-bachman.md` - Sprint 12 section
...
**Implementation Plan**: `/root/.claude/plans/curried-petting-bachman.md` - Sprint 12
