...
**Your sprint**: @documentation/sprints/calendar/sprint_2
...
1. **Your Sprint Document**: @documentation/sprints/calendar/sprint_3 (read FIRST)
2. **Your Bible**: `api/documentation/calendar_REST_API.md` (authoritative source for all endpoints)
