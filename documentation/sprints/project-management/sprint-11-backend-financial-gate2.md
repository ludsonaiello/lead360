...
**Indexes**: @@index([tenant_id, financial_entry_id]), @@index([tenant_id, project_id]), @@index([tenant_id, task_id]), @@index([tenant_id, is_categorized]), @@index([tenant_id, created_at])
**Map**: @@map("receipt")
